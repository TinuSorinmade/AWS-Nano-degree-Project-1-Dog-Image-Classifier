...
def calculates_results_stats(results_dic):
    ...
    """        
    # Initialize counters in the statistics dictionary
    results_stats_dic = {
        'n_match': 0,
        'n_correct_breed': 0,
        'n_dogs_img': 0,
    ...
    for key in results_dic:
        # If labels match perfectly
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1

        # If the image is of a dog and the breed is correctly classified
        if sum(results_dic[key][2:]) == 3:
            results_stats_dic['n_correct_breed'] += 1

        # If the image is labeled as a dog
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1

            # If the classifier correctly identifies it as a dog
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1

        # If the image is not labeled as a dog
        else:
            # If the classifier correctly identifies it as not a dog
    ...
    # Total number of images not labeled as dogs
    ...
    # Calculate percentage of correctly identified non-dog images
